							...
							if( last == "com" || last == "edu")
							{
								...
								if( male == true || female == true || other == true)
								{
									...
									if(devide[0] >=1 & devide[0] <= 31 & devide[1] >=1 & devide[1] <= 12 & devide[2] >=1940 & devide[2] <= 2005)
									{
										...
										var devide = phoneno.split("");
										if (devide.length==11) 
										{
											var d=false;
											for (var i=0;i<devide.length;i++) 
											{
												if (devide[i]>=0 & devide[i]<=9) 
												{
													continue;
												}
												else
											...
											if (d==false) 
											{
												...
												{
													show6.innerHTML="Address can not be empty!";
													return false;
												}
											...
											{
												show5.innerHTML="Digit must need to be 0-9!";
												return false;
											}
										}
										else
										{
											show5.innerHTML="Must Need To Be 11 Digit Number!";
											return false;
										}
									}
									else
									{
										show4.innerHTML="Date of birth is invalid!";
										return false;
									}
								}
								else
