function validate()
{
	var show1 = document.getElementById('show5');
			...
			if ( count >= 2) 
			{
					...
					a[0]=='W' || a[0]=='X'  || a[0]=='Y' || a[0]=='Z')
				{
					...
					if(decision=="valid")
					{
							...
							if(count==1)
							{
								...
								if( last == "com" || last == "edu")
								{
									...
									if( gender == male || gender == female || gender == other)
									{
										...
										var devide = dob.split("/");
										if(devide[0] >=1 & devide[0] <= 31 & devide[1] >=1 & devide[1] <= 12 & devide[2] >=1940 & devide[2] <= 2005)
										{
											return true;
										}
										else
										{
											show5.innerHTML="Date of birth is invalid!";
											return false;
										}
									}
									else
									{
										show4.innerHTML = "At least one of them has to be selected";
										return false;
									}
								}
								else
								{
									show3.innerHTML = "Must be a valid email address (i.e anything@example.com)";
									return false;
								}
							}
							else
						...
						{
							show3.innerHTML = "Cannot be empty";
							return false;
						}
					}
					else
					{
						show2.innerHTML = "Can contain a-z or A-Z or dot(.) or dash(-)";
						return false;	
					}
				...
				{
					show2.innerHTML = "Must start with a letter";
					return false;
				}
			}
			else
			{
				show2.innerHTML = "Contains at least two words";
				return false;
			}	
