...
<html>
<head>
	<title>Trainer Delete Attendance File</title>
</head>
<body>
	<fieldset>
	...
	<fieldset>
		<table cellspacing="0" cellpadding="5" border="1" width="100%">
			<tr>
				...
				<td align="Center">
					<form action="../php/trainerAttendanceController.php" method="post">
						<fieldset>
							<legend>Confirmation</legend>
								Press Yes to delete this user and press No to go back <br/>
								<input type="hidden" name="id" value="<?=$attendance['id']?>">
								<input type="hidden" name="file" value="<?=$attendance['file']?>">
