				...
				<td align="Center">
					<table border="1" width="100%" cellspacing="0" cellpadding="5">
						...
						<tr>
							...
							<td><?=$students[$i]['courseid']?></td>
							<td>
								<a href="adminEditStudent.php?studentid=<?=$students[$i]['studentid']?>">Edit</a>
								<a href="adminDeleteStudent.php?studentid=<?=$students[$i]['studentid']?>">Delete</a> 
							</td>
						</tr>
