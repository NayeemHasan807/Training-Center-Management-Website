...
<head>
	...
	<script type="text/javascript" src="../assets/js/adminAddInformations.js"></script>
    ...
    <table cellspacing="0" cellpadding="5" width="100%" border="1">
	    <tr>
			...
			<td>
			    <fieldset>
			    	<form>
						<legend><b>CREATE NEW INFORMATION</b></legend>
						<table>
							<tr>
								<td>Information Name</td>
								<td><input type="text" id="informationname" name="informationname" onclick ="check1()"></td>
								<td id="show1"></td>
							</tr>
							<tr>
								<td>Information Body</td>
								<td><textarea rows="5" cols="40" id="informationbody" name="informationbody" onclick ="check2()"></textarea></td>
								<td id="show2"></td>
							</tr>
							<tr>
								<td></td>
								<td>
									...
									<input type="button" id="addinformations" name="addinformations" value="Send" onclick="validate()">
