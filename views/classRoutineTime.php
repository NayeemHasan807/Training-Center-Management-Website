<?php
	...
	require_once('../service/classRoutineTimeService.php');
...
<html>
<head>
	<title>Class Routine And Time</title>
	...
	<fieldset>
		<table cellspacing="0" cellpadding="5" border="1" width="100%">
			<tr>
				...
				<td rowspan="6">
					<fieldset>
					    <legend><b>Class Routine And Time</b></legend>
						<br/>
						<table cellspacing="0" cellpadding="5" border="1" width="100%">
	                        <tr>
	                        	<td>Course Name</td>
						    ...
						    ?> 
							<?php 
			             	    $classRoutineTime = classRoutineTime($userid);
								for ($i=0; $i != count($classRoutineTime); $i++) {  ?>
							<tr>
								<td><?=$classRoutineTime[$i]['coursename']?></td>
								<td><?=$classRoutineTime[$i]['courseday']?></td>
								<td><?=$classRoutineTime[$i]['coursetime']?></td>
							</tr>
