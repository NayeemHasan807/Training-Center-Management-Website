...
<!DOCKTYPE html>
<head>
	<title>informations manage</title>
...
<fieldset>
    <table cellspacing="0" cellpadding="5" width="100%" border="1">
	    <tr>
			...
			<td>
			    <ul>
			    	<li><a href="adminAddInformations.php"><font color='red'>Add Informations</font></a></li>
			    	<li><a href="adminViewAllInformations.php"><font color='red'>View All Informations</font></a></li>
