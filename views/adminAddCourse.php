...
<fieldset>
    <table cellspacing="0" cellpadding="5" width="100%" border="1">
	    <tr>
			...
			<td>
				<form action="../php/adminAddCourseController.php" method="POST">
			    <fieldset>
					<legend><b>CREATE NEW COURSE</b></legend>
						<table>
							<tr>
								<td>Course ID</td>
							...
							<tr>
								<td>Course Day</td>
								<td><input type="text" name="courseday"></td>
							</tr>
							<tr>
								<td>Course Time</td>
							...
							<tr>
								<td>Sit Available</td>
								<td><input type="text" name="sitavailable"></td>
							</tr>
							<tr>
								<td></td>
								<td>
									...
									<input type="submit" name="addcourse" value="Create">
