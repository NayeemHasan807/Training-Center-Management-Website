...
<head>
	...
	<script type="text/javascript" src="../assets/js/studentUploadAssignment.js"></script>
</head> 
<body>
	<fieldset>
	...
	<fieldset>
		<table cellspacing="0" cellpadding="5" border="1" width="100%">
			<tr>
				...
				<td rowspan="6">
					<fieldset>
						<form action="../php/assignmentController.php" method="POST" enctype="multipart/form-data" onsubmit="return validate()">
					    <legend><b>Upload Assignment</b></legend>
						<br/>
						<table cellspacing="0" cellpadding="5" border="1" width="100%">
							<tr>
								<td width="20%">Upload Assignment :</td>
								<td>
									<input type="file" id="assignment" name="assignment" onclick="click1()">
								</td>
								<td id="show1"></td>
							</tr>
							<tr>
								<td width="20%" colspan="3">
									<input type="submit" id="uploadassignment" name="uploadassignment" value="Upload">
