...
<html>
<head>
	<title>Send Mail To Peer</title>
	<link rel="stylesheet" type="text/css" href="../assets/css/studentStyle.css">
	<script type="text/javascript" src="../assets/js/sendMailToPeer.js"></script>
</head> 
<body>
	<fieldset>
	...
	<fieldset>
		<table cellspacing="0" cellpadding="5" border="1" width="100%">
			<tr>
				...
				<td rowspan="6">
					<fieldset>
					    <legend><b>Send Mail To Peer</b></legend>
						<form>
							<br/>
							<table>
								<tr>
