<?php
	...
	require_once('../service/trainerDetailsService.php');
				...
				<td rowspan="6">
					<fieldset>
						...
						<table cellspacing="0" cellpadding="5" border="1" width="100%">
							...
							<tr>
								<td><?=$trainer[$i]['coursename']?></td>
								<td><?=$trainer[$i]['trainerid']?></td>
								<td><?=$trainer[$i]['name']?></td>
								<td><?=$trainer[$i]['email']?></td>
								<td><?=$trainer[$i]['eduqualification']?></td>
							</tr>
